...
const C = {
  ...
  "m12": { t: "Module 12 — Payment & Client Onboarding", st: "Send invoices professionally. Onboard with precision.", s: [
    ...
    { h: "📧  THE EMAIL TEMPLATE", b: "Subject: Redline Web Services — Next Steps & Onboarding | [CLIENT COMPANY NAME]\n\nHey [CLIENT FIRST NAME],\n\nGreat talking with you. Here's what we need to kick things off:\n\n1. Complete Your Onboarding Form (5 min):\nhttps://forms.gle/EGaHjGUffqdGBH8v9\n\n2. Complete Your Payment:\n[Include only the correct Stripe link]\n\nOnce we have both, we start immediately. You'll hear from us within [TURNAROUND TIME].\n\nQuestions? Reply here or text me at [YOUR PHONE NUMBER].\n\n[YOUR NAME]\nRedline Web Services" },
  ]},
  ...
  "onboard-email": { t: "Client Onboarding Email Template", st: "Post-close email with payment links and onboarding form.", s: [
