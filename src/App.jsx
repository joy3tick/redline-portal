            ...
            {days.slice(week*5, week*5+5).map((day, di) => {
              ...
              return (
                <div key={dateStr} onClick={() => !isPast && toggle(day)}
                  ...
                  style={{ background: isMine?"#DC262608":"#23262E", border:"1px solid "+(isMine?"#DC262630":isToday?"#404450":"#2D3038"), borderRadius:16, padding:"16px 14px", cursor:isPast?"default":"pointer", opacity:isPast?0.35:1, transition:"all 0.2s", minHeight:140, position:"relative" }}>
                  ...
                  <div style={{ fontSize:9, color:"#5C6175", marginBottom:12, letterSpacing:1 }}>9:00 AM – 5:00 PM</div>
